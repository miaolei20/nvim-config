return {
  ...
  progress = {
    display = {
      done_icon = "󰄬 ",        -- ✅ 完成的图标
      progress_icon = "󰁕 ",   -- ✅ 处理中的图标
      spinner = "dots",       -- ✅ 加载动画样式
      render_limit = 16,      -- ✅ 最大并行显示任务数

      -- ❌ 移除下列已废弃的参数 --
      -- group_icon = " ",  -- 已不可用
      -- icon = "...",       -- 已拆分为 done_icon/progress_icon
    },
    ignore_done_already = true,  -- ✔️ 新版本推荐的补充配置
  },
  notification = {
    window = {
      winblend = 0,
      border = "rounded"  -- ✔️ 建议添加边框样式
    }
  }
})
