return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "zr", ufo.openFold, { desc = "展开当前折叠" })
    vim.keymap.set("n", "zP", ufo.toggleFold, { desc = "切换当前折叠" })
    vim.keymap.set("n", "zm", ufo.closeFold, { desc = "折叠当前层级" })
    vim.keymap.set("n", "zv", ufo.openFoldRec, { desc = "递归展开当前折叠" })
    vim.keymap.set("n", "zV", ufo.closeFoldRec, { desc = "递归折叠当前层级" })
